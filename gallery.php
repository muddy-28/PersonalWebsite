...
<head>
    <meta charset="UTF-8">
    <title>Gallery - Champion Programming</title>
...
<? include("header.php") ?>
    ...
    <div class="col1 border resize galleryDiv">
        <a class="fill"  href="<cms:editable name='gallery1' label='gallery1' type='image' group='gallery1'></cms:editable>"
           ...
           data-title="<cms:editable group='gallery1' name='gallery1_caption' label='gallery1_caption' type='textarea'/>">
    ...
    <div class="col1 border resize galleryDiv">
        <a class="fill"  href="<cms:editable group='gallery2' name='gallery2' label='gallery2' type='image'></cms:editable>"
           data-lightbox="gallery"
           data-title="<cms:editable group='gallery2' name='gallery2_caption' label='gallery2_caption' type='textarea' />">
    ...
    <div class="col1 border resize galleryDiv">
        <a class="fill"  href="<cms:editable group='gallery3' name='gallery3' label='gallery3' type='image'></cms:editable>"
           data-lightbox="gallery"
           data-title="<cms:editable group='gallery3' name='gallery3_caption' label='gallery3_caption' type='textarea' />">
    ...
    <div class="col1 border resize galleryDiv">
        <a href="<cms:editable group='gallery4' name='gallery4' label='gallery4' type='image'></cms:editable>"
           data-lightbox="gallery"
           data-title="<cms:editable group='gallery4' name='gallery4_caption' label='gallery4_caption' type='textarea' />">
    ...
    <div class="col1 border resize galleryDiv">
        <a class="fill"  href="<cms:editable group='gallery5' name='gallery5' label='gallery5' type='image'></cms:editable>"
           data-lightbox="gallery"
           data-title="<cms:editable group='gallery5' name='gallery5_caption' label='gallery5_caption' type='textarea' />">
    ...
    <div class="col1 border resize galleryDiv">
        <a class="fill"  href="<cms:editable group='gallery6' name='gallery6' label='gallery6' type='image'></cms:editable>"
           data-lightbox="gallery"
           data-title="<cms:editable group='gallery6' name='gallery6_caption' label='gallery6_caption' type='textarea' />">
    ...
    <div class="col1 border resize galleryDiv">
        <a href="<cms:editable group='gallery7' name='gallery7' label='gallery7' type='image'></cms:editable>"
           data-lightbox="gallery"
           data-title="<cms:editable group='gallery7' name='gallery7_caption' label='gallery7_caption' type='textarea' />">
    ...
    <div class="col1 border resize galleryDiv">
        <a href="<cms:editable group='gallery8' name='gallery8' label='gallery8' type='image'></cms:editable>"
           data-lightbox="gallery"
           data-title="<cms:editable group='gallery8' name='gallery8_caption' label='gallery8_caption' type='textarea' />">
    ...
    <div class="col1 border resize galleryDiv">
        <a class="fill"  href="<cms:editable group='gallery9' name='gallery9' label='gallery9' type='image'></cms:editable>"
           data-lightbox="gallery"
           data-title="<cms:editable group='gallery9' name='gallery9_caption' label='gallery9_caption' type='textarea' />">
    ...
    <div class="col1 border resize galleryDiv">
        <a class="fill"  href="<cms:editable group='gallery10' name='gallery10' label='gallery10' type='image'></cms:editable>"
           data-lightbox="gallery" 
           data-title="<cms:editable group='gallery10' name='gallery10_caption' label='gallery10_caption' type='textarea' />">
